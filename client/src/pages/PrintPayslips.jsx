...
const PrintPayslips = () => {
  ...
  return (
    <div className='max-w-2xl mx-auto p-8 animate-fade-in bg-white'>
        ...
        <table className='w-full text-sm'>
          ...
          <tbody>
            <tr className='border-t border-slate-100'>
              <td className='py-3 px-4 to-slate-700'>Basic Salary</td>
              <td className='text-right py-3 px-4 to-slate-900 font-medium'>${payslip.basicSalary?.toString()}</td>
            </tr>
            <tr className='border-t border-slate-100'>
              <td className='py-3 px-4 to-slate-700'>Allowances</td>
              <td className='text-right py-3 px-4 to-slate-900 font-medium'>+${payslip.allowances?.toString()}</td>
            </tr>
            <tr className='border-t border-slate-100'>
              <td className='py-3 px-4 to-slate-700'>Deductions</td>
              <td className='text-right py-3 px-4 to-slate-900 font-medium'>-${payslip.deductions?.toString()}</td>
            </tr>
            <tr className='border-t-2 border-slate-200 bg-slate-50'>
              <td className='py-3 px-4 font-bold to-slate-900'>Net Salary</td>
              <td className='text-right py-4 px-4 font-bold to-slate-900 text-lg'>${payslip.netSalary?.toString()}</td>
            </tr>
          </tbody>
      ...
      <div className='text-center'>
        <button className='btn-primary cursor-pointer print:hidden' onClick={() => window.print()}>
          Print Payslip
        </button>
      </div>
