...
const Sidebar = () => {
  ...
  // close mobile sidebar on changing route
  useEffect(() => {
    setMobileOpen(false);
  }, [pathname]);
  ...
  const sidebarContent = (
    <>
        ...
        <div className="flex items-center justify-between">
          <div className="flex w-full items-center justify-between">
            ...
            <button
              ...
              className="lg:hidden cursor-pointer text-slate-400 hover:text-white p-1"
            >
              <XIcon size={20} />
            </button>
          </div>
      ...
      <div className="p-3 border-t border-white/6">
        <button onClick={handleLogout} className="flex cursor-pointer items-center gap-3 w-full px-3 py-2.5 rounded-md text-[13px] font-medium text-slate-400 hover:text-rose-400 hover:bg-rose-500/8 transition-all duration-150">
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden cursor-pointer fixed top-4 left-4 z-50 p-2 bg-slate-900 text-white rounded-lg shadow-lg border border-white/10"
      >
        <Menu size={20} />
      </button>
